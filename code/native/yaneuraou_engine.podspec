...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/irep-takeshi-maya/shogi-ai-research'
  s.license          = { :type => 'GPLv3' }
  s.author           = { 'shogi-ai-research' => 'noreply@example.com' }
  s.source           = { :path => '.' }
  s.platform         = :ios, '13.0'
  ...
  s.pod_target_xcconfig = {
    ...
    'GCC_PREPROCESSOR_DEFINITIONS' => 'NDEBUG=1 _LINUX=1 UNICODE=1 NO_EXCEPTIONS=1 IS_64BIT=1 USE_NEON=1 YANEURAOU_ENGINE_NNUE=1 EVAL_NNUE_HALFKP256=1',
